  ...
  <nord-navigation slot="nav">
    <nord-dropdown slot="header" expand>
      <nord-button slot="toggle" expand variant="switch">
        <span slot="start" aria-hidden="true" class="n-clinic-icon"
          ><span>B</span></span
        >
        Bath Clinic
        <nord-icon
      ...
      <nord-dropdown-group
        style="min-inline-size: 270px"
        heading="laura.williams@nordhealth.com"
      >
        <nord-dropdown-item>
          <span
            aria-hidden="true"
        ...
        <nord-dropdown-item>
          <span
            aria-hidden="true"
            style="
              --n-icon-color: var(--n-color-status-success);
              --n-icon-size: calc(var(--n-size-icon-l) / 1.2);
            "
            slot="start"
            class="n-clinic-icon"
            >O</span
        ...
        <nord-dropdown-item>
          <span
            aria-hidden="true"
            style="
              --n-icon-color: var(--n-color-status-info);
              --n-icon-size: calc(var(--n-size-icon-l) / 1.2);
            "
            slot="start"
            class="n-clinic-icon"
        ...
        <nord-dropdown-item>
          <span
            aria-hidden="true"
            style="
              --n-icon-color: var(--n-color-status-danger);
              --n-icon-size: calc(var(--n-size-icon-l) / 1.2);
            "
            slot="start"
            class="n-clinic-icon"
    ...
    <nord-nav-group>
      <nord-nav-item aria-describedby="search" icon="navigation-search"
        >Search</nord-nav-item
      >
      ...
      <nord-nav-item icon="navigation-tasks" aria-describedby="tasks"
        >My tasks</nord-nav-item
      >
    ...
    <nord-nav-group heading="Workspace">
      ...
      <RouterLink to="/settings" v-slot="{ navigate, href, isActive }" custom>
        <nord-nav-item
          icon="navigation-settings"
          :href="href"
          @click="navigate"
          :active="isActive || null"
          >Settings</nord-nav-item
        >
      </RouterLink>
    </nord-nav-group>
